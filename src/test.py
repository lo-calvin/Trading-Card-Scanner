...
async def main():
    det = Detector(os.path.join("res", "detection_weights", "yolo11n_seg_best_10epochs.pt"))
    ret = Retriever(os.path.join("res", "classfication_embeddings", "ResNet18_embeddings.pt"))
